 ...
 * This is not working code , BAISED.java is working code with Time limit exceeded.
 */
public class Main {
    ...
    private static void findBadness(int i) {
        ...
        TreeMap<String,BigInteger> input1 = new TreeMap<String,BigInteger>();

        for (int j = 0; j < i; j++) {
            input1.put(scan.next(),scan.nextBigInteger());
        }
